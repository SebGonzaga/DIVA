...
navigator.geolocation.getCurrentPosition(async function (position) {
    try {
        ...
        cityMain.innerHTML = data.name; // Display city name
        cityTemp.innerHTML = Math.floor(data.main.temp) + "°"; // Display current temperature
        weatherMain.innerHTML = data.weather[0].description; // Display weather description
        tempMinWeather.innerHTML = Math.floor(data.main.temp_min) + "°"; // Display min temperature
        tempMaxWeather.innerHTML = Math.floor(data.main.temp_max) + "°"; // Display max temperature

        let weatherCondition = data.weather[0].main.toLowerCase();
        console.log("Weather Condition:", weatherCondition); // Debugging line
        ...
        if (weatherCondition === "rain") {
            ...
            weatherImgs.src = "img/default.png"; // Fallback image if no condition matches
        }
        ...
        fetch(forecastUrl)
            ...
            .then(data => {
                console.log("5-Day Forecast for", data.city.name); // Debugging line
        ...
        function displayForecast(data) {
            ...
            for (const date in dailyForecasts) {
                ...
                switch (dailyForecasts[date].weatherImg) {
                    ...
                    case "haze":
                        ...
                        break;
                    default:
                        imgSrc = "img/default.png"; // Fallback image
                }
            ...
            console.log(data); // Debugging line to check forecast data
        }
    } catch (error) {
